...
describe("MCP Tools", function()
  ...
  it("should have expected tools", function()
    ...
    for _, name in ipairs(tool_names) do
      if name:match('buffer') then has_buffer_tool = true end
      if name:match('command') then has_command_tool = true end
    end
...
describe("MCP Resources", function()
  ...
  it("should have expected resources", function()
    ...
    for _, name in ipairs(resource_names) do
      if name:match('buffer') then has_buffer_resource = true end
      if name:match('git') then has_git_resource = true end
    end
