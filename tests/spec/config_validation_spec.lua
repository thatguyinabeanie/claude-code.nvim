...
describe('config validation', function()
  ...
  describe('keymaps validation', function()
    it('should validate keymaps.toggle.normal can be a string or false', function()
      ...
      local result1 = config.parse_config(valid_config1)
      local result2 = config.parse_config(valid_config2)
      local result3 = config.parse_config(invalid_config)
    ...
    it('should validate keymaps.window_navigation must be a boolean', function()
      ...
      local result = config.parse_config(invalid_config)
      assert.are.equal(config.default_config.keymaps.window_navigation, result.keymaps.window_navigation)
    end)
  end)
end)