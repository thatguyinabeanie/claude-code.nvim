...
describe('Flexible CI Test Helpers', function()
  ...
  function test_helpers.get_test_paths(env)
    ...
    return {
      ...
      local_claude = env.home_dir .. env.path_sep .. '.claude' .. env.path_sep .. 'local' .. env.path_sep .. 'claude' .. env.executable_ext,
  ...
  function test_helpers.assert_notification_structure(notification)
    ...
    assert.is_true(notification.level >= vim.log.levels.TRACE and notification.level <= vim.log.levels.ERROR)
  end
